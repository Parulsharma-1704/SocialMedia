  ...
  return (
    <div className='fixed inset-0 z-110 h-screen overflow-y-scroll bg-black/50'>
        <div className='flex flex-col justify-center items-center mt-10 mb-10'>
            <div className='bg-white rounded-lg shadow p-6 w-2xl'>
                ...
                <form onSubmit={handleSaveProfile}>
                            ...
                            className='w-full p-3 border border-gray-200 rounded-lg'
                             ...
                             <div className='group/profile relative'>
                                ...
                                : user.profile_picture} alt="" className='w-24 h-24 rounded-full object-cover mt-2'/>
                                 <div className='absolute hidded group-hover/profile:flex inset-0
                        ...
                        <label htmlFor='cover_photo' className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            className='w-full p-3 border border-gray-200 rounded-lg'
                             ...
                             <div className='group/cover relative'>
                                ...
                                <div className='absolute hidden group-hover/cover:flex inset-0 bg-black/20 rounded-lg items-center
                                justify-center'>
                                    <GoPencil className='w-5 h-5 text-white'/>
                                </div>
                             </div>
                    ...
                    <div className='flex justify-end pt-6 space-x-4'>
                        ...
                        <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white 
                        rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer'>Save</button>
                    </div>
                </form>
            </div>
        </div>
